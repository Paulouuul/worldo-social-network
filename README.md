...
- Armazenamento de mídia dos usuários no Cloudflare R2 (Integração com módulo [backend](https://github.com/Paulouuul/worldo-social-network)". em outro repositório)
- Envio de email de confirmação com ReSend

## Integração com [Backend](https://github.com/Paulouuul/worldo-social-network)".
