  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-800/80 shadow-2xl p-8 relative z-10">
        ...
        {/* Alertas de Erro */}
        {error && (
          <div className="bg-red-500/10 text-red-400 p-3 rounded-xl mb-4 text-xs border border-red-500/20 flex items-center gap-2 animate-fade-in">
        ...
        {/* Alertas de Sucesso */}
        {success && (
          <div className="bg-emerald-500/10 text-emerald-400 p-3 rounded-xl mb-4 text-xs border border-emerald-500/20 flex items-center gap-2 animate-fade-in">
        ...
        <p className="text-center text-slate-400 mt-6 text-xs tracking-wide">
          Não tem uma conta?{' '}
          <Link href="/register" className="text-purple-400 hover:text-purple-300 font-semibold inline-flex items-center gap-0.5 group transition-colors">
            Registre-se <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
          </Link>
        </p>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center">
        ...
        <span className="ml-3 mt-4 text-purple-300 font-medium text-sm">Carregando portal...</span>
      </div>
    }>
      <LoginContent />
    </Suspense>
