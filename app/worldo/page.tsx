...
export default async function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20 relative antialiased text-slate-100 selection:bg-purple-500/30 overflow-hidden sm:overflow-visible">
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[300px] sm:w-[600px] h-[200px] sm:h-[300px] bg-purple-600/15 rounded-full blur-[80px] sm:blur-[120px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 text-center mb-12 sm:mb-16">
        ...
        <div className="bg-slate-900/50 border border-white/[0.06] p-6 sm:p-10 md:p-14 rounded-2xl sm:rounded-3xl max-w-3xl mx-auto backdrop-blur-xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 relative z-10">
        ...
        <div className="bg-slate-900/40 border border-white/[0.04] p-6 sm:p-8 rounded-2xl backdrop-blur-sm shadow-xl hover:-translate-y-1 hover:bg-slate-900/60 hover:border-purple-500/30 transition-all duration-300 group">
        ...
        <div className="bg-slate-900/40 border border-white/[0.04] p-6 sm:p-8 rounded-2xl backdrop-blur-sm shadow-xl hover:-translate-y-1 hover:bg-slate-900/60 hover:border-amber-500/30 transition-all duration-300 group">
        ...
        {/* Card 3: Chat Social */}
        <div className="bg-slate-900/40 border border-white/[0.04] p-6 sm:p-8 rounded-2xl backdrop-blur-sm shadow-xl hover:-translate-y-1 hover:bg-slate-900/60 hover:border-blue-500/30 transition-all duration-300 group">
