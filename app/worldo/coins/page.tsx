    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-slate-400">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-medium animate-pulse tracking-wide">Carregando loja com segurança...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="relative rounded-3xl border border-slate-800 bg-slate-900/50 p-8 md:p-12 text-center overflow-hidden backdrop-blur-md shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-base md:text-lg text-slate-400 max-w-md mx-auto font-normal leading-relaxed">
              Desbloqueie recursos exclusivos, impulsione seu progresso e eleve sua experiência agora mesmo.
            </p>
              ...
              <div className="bg-slate-950/60 border border-slate-800/80 rounded-2xl p-1.5 backdrop-blur-md shadow-inner">
                <div className="flex items-center gap-4 px-6 py-3 bg-gradient-to-r from-blue-950/30 to-purple-950/30 rounded-xl">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest">Seu Saldo Atual</p>
                    <p className="text-2xl md:text-3xl font-black text-white tracking-tight">
                      {balance.toLocaleString()}<span className="text-sm font-medium text-slate-400 ml-1.5">moedas</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-grow items-center text-center space-y-6">
                ...
                <div className="w-full bg-slate-950/40 rounded-xl p-4 border border-slate-800/40 space-y-2">
                  <div className="flex items-center justify-center gap-2.5">
                    ...
                    <span className="text-sm font-bold text-slate-400 uppercase tracking-wider">Moedas</span>
                  </div>
                ...
                <div className="pt-2">
                  <p className="text-4xl font-black text-white tracking-tight">
                    ...
                    {pkg.priceReal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </p>
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/20 p-8 md:p-12 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h4 className="text-white font-bold text-base tracking-tight">Ambiente 100% Seguro</h4>
              <p className="text-slate-400 text-xs leading-relaxed max-w-xs">
                Criptografia de ponta a ponta processada via Stripe, referência mundial em segurança financeira.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p className="text-slate-400 text-xs leading-relaxed max-w-xs">
                Sem filas ou validações manuais. O saldo é atualizado em sua conta segundos após a aprovação.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-400 leading-relaxed px-4">
                  Você escolheu o pacote <strong className="text-blue-400 font-semibold">{selectedPackage.name}</strong>. Revise os dados abaixo:
                </p>
              </div>
              ...
              <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-4 text-sm divide-y divide-slate-800/80 space-y-3">
                ...
                <div className="flex justify-between items-center pt-3 font-medium">
                  ...
                  <span className="text-white font-black text-lg">
                    R$ {selectedPackage.priceReal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </span>
                </div>
              </div>
