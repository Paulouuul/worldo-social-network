...
export default function CancelPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative antialiased selection:bg-purple-500/30 bg-[#020617]">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-rose-600/10 rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="fixed top-1/3 right-1/4 w-[300px] h-[300px] bg-purple-600/10 rounded-full blur-[100px] pointer-events-none z-0" />

      {/* Card Glassmorphism */}
      <div className="relative z-10 w-full max-w-md bg-slate-900/50 border border-white/[0.06] rounded-2xl p-8 md:p-10 backdrop-blur-xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.7)] text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 rounded-full bg-rose-500/10 flex items-center justify-center border border-rose-500/20 relative">
            <div className="absolute inset-0 rounded-full bg-rose-500/20 blur-[12px] animate-pulse" />
        ...
        <div className="bg-slate-950/40 border border-white/[0.04] rounded-xl p-5 mb-8 shadow-inner relative overflow-hidden">
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-rose-500/50 to-transparent" />
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link 
            href="/" 
            className="flex items-center justify-center gap-2.5 w-full py-3.5 px-4 rounded-xl text-sm font-bold tracking-wide bg-slate-800/50 border border-white/[0.06] hover:border-white/[0.12] hover:bg-slate-800 text-slate-300 hover:text-white transition-all duration-300 shadow-lg active:scale-[0.98] group"
          >
