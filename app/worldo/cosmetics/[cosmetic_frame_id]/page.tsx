  ...
  if (!frame) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/cosmeticos" className="btn-primary inline-block mt-4">Voltar ao Marketplace</Link>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
        <Link href="/cosmeticos" className="hover:text-white transition">Marketplace</Link>
        <span>/</span>
        ...
        <div className="space-y-6">
          ...
          {!frame.hasActiveListing && (
            <div className="p-6 bg-slate-800/30 rounded-2xl text-center">
              ...
              <Link href="/cosmeticos" className="btn-secondary inline-block mt-3">
                Ver outras molduras
              </Link>
            </div>
          )}
