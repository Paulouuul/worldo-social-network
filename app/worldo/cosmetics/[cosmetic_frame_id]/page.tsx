  ...
  if (!frame) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/worldo/cosmetics/marketplace" className="btn-primary inline-block mt-4">
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
        <Link href="/worldo/cosmetics/marketplace" className="hover:text-white transition">
          Marketplace
        </Link>
        <span>/</span>
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs font-bold border ${rarityColor} ${rarityTextColor}`}
              >
                {frame.rarity}
              </span>
            </div>
          ...
          <div className="flex items-center gap-3 p-4 bg-slate-800/30 rounded-xl">
            ...
            <div>
              ...
              <Link
                href={`/worldo/perfil/${frame.creator.username}`}
