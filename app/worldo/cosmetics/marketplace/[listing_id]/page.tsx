    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2">
          <div
            className={`relative rounded-3xl border overflow-hidden flex flex-col items-center justify-center p-8 min-h-100 h-full ${config.cardClass}`}
          >
              ...
              <div className="flex gap-4">
                ...
                <div className="w-2/3">
                  ...
                  <div className="w-full bg-slate-950/50 border border-slate-800/50 rounded-xl px-4 py-3.5 text-right font-black text-amber-400 flex justify-end items-center gap-2">
                    ...
                    <Coins className="w-4 h-4 text-amber-500/70" />
                  </div>
                </div>
              </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-auto w-full z-10 pt-2 border-t border-slate-800/40">
                    <span
                      className={`block text-xs sm:text-sm text-center px-1 truncate drop-shadow-md ${itemConfig.textClass}`}
                    >
                      {item.frame.name}
                    </span>
                  </div>
